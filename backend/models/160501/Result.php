...
class Result extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            // [['title', 'moderation', 'listsql_id', 'parent_id', 'comment_TutorAboutPupil'.$this->idRequireUser, 'mark_TutorAboutPupil'.$_SESSION['idRequireUser'], 'date_TutorAboutPupil1', 'comment_Pupil1AboutTutor', 'mark_Pupil1AboutTutor', 'date_Pupil1AboutTutor', 'commentMaximum_TutorAboutPupil1', 'markMaximum_TutorAboutPupil1', 'dateMaximum_TutorAboutPupil1', 'commentMaximum_Pupil1AboutTutor', 'markMaximum_Pupil1AboutTutor', 'dateMaximum_Pupil1AboutTutor', 'comment_Pupil1AboutPupil1', 'mark_Pupil1AboutPupil1', 'date_Pupil1AboutPupil1', 'commentMaximum_Pupil1AboutPupil1', 'markMaximum_Pupil1AboutPupil1', 'dateMaximum_Pupil1AboutPupil1'], 'required'],
            [['moderation', 'listsql_id', 'parent_id', 'grade_id', 'mark_TutorAboutPupil'.$idUser, 'mark_Pupil1AboutTutor', 'markMaximum_TutorAboutPupil'.$idUser, 'markMaximum_Pupil1AboutTutor', 'mark_Pupil1AboutPupil'.$idUser, 'markMaximum_Pupil1AboutPupil1'], 'integer'],
