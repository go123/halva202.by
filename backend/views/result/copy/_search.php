...
<div class="result-search">
    ...
    <?= $form->field($model, 'comment_TutorAboutPupil1') ?>

    <?= $form->field($model, 'mark_TutorAboutPupil1') ?>

    <?= $form->field($model, 'date_TutorAboutPupil1') ?>
    ...
    <?php // echo $form->field($model, 'mark_Pupil1AboutPupil1') ?>

    <?php // echo $form->field($model, 'date_Pupil1AboutPupil1') ?>

    <?php // echo $form->field($model, 'commentMaximum_Pupil1AboutPupil1') ?>

    <?php // echo $form->field($model, 'markMaximum_Pupil1AboutPupil1') ?>

    <?php // echo $form->field($model, 'dateMaximum_Pupil1AboutPupil1') ?>

    <?php // echo $form->field($model, 'moderationPupil1') ?>
